...
mod tests {
    ...
    async fn main() {
        ...
        let expected: Vec<LogRecord> = vec![LogRecord::new("telog-test container", "log_entry")];
    ...
    async fn create_container() -> Result<()> {
        ...
        docker
            .start_container("telog-test", None::<StartContainerOptions<String>>)
            .await?;
    ...
    async fn delete_container() -> Result<()> {
        ...
        docker.remove_container("telog-test", options).await?;
